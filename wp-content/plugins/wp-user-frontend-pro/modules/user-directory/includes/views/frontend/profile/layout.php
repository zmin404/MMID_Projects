<div class="wpuf-ud-single-profile">
    <div class="user-profile">
        <div class="user-metada">
            <div class="user-image">
                <?php echo get_avatar( $user->user_email, 120 ); ?>
            </div>
            <div class="username">
                <p><?php echo esc_attr( $user->display_name, 'wpuf-pro' ); ?></p>
            </div>
        ...
        <div class="user-biography">
            <div class="bigrophy-title">
                <h4>Biography</h4>
            </div>
            <div class="biography-descrition">
            ...
            <ul>
                ...
                <?php
                    foreach ( $tabs as $key => $tab ):
                        if ( $key === 'activity' && ! class_exists( 'WPUF_User_Activity' )){
                            continue;
                        }
