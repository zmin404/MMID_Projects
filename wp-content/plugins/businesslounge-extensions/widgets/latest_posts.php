...
class Latest_Posts extends WP_Widget {
	...
	public function __construct() {
		$opts =array(
					...
					'description' 	=> _x( 'The most recent posts on your site with post thumbnails and date boxes.', 'Admin Panel','businesslounge' )
				);

		parent::__construct('latest_posts_2', '['. RT_THEMENAME.']   '._x('Recent Posts ', 'Admin Panel','businesslounge'), $opts);
	}
