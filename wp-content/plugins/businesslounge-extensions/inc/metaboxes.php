		...
		*/
		function displayCustomFields() {
			...
			?>
			 <div class="rt-metaboxes">
				...
				foreach ( $this->customFields as $customField ) {
					...
					$help_icon = ! empty( $description ) ? '<span title="'._x('click for more information','Admin Panel','businesslounge').'" class="tooltip_icon rt-panel-icon-help-circled"></span>' : "";
					...
					if ( $output ) { ?>
							...
							switch ( $customField[ 'type' ] ) {
								...
								case 'selectmultiple':{
									...
									echo '<select multiple name="'.$id.'" id="'.$html_id.'" class="multiple '.$class.' "  title="'._x('Select','Admin Panel','businesslounge').'">';
								...
								<button data-inputid="'.$html_id.'" class="rt-panel-icon-upload template_button light rttheme_upload_button" type="button">'._x('Upload','Admin Panel','businesslounge').'</button>
								</div>';
								...
								echo '<span class="rt-panel-icon-cancel delete_single" title="'._x("remove image",'Admin Panel','businesslounge').'" data-inputid="'.$html_id.'"></span>';
								echo '</div>';
								echo '</td></tr></table>';		
								...
								<button data-inputid="'.$html_id.'" class="rt-panel-icon-upload template_button light rttheme_image_upload_button" type="button">'._x('Upload','Admin Panel','businesslounge').'</button>
								</div>';
			...
			<?php if( $this->settings['slug'] == "rt_design_custom_fields" ):?>
				<div class="rt-metaboxes-footer"><a href="#" id="reset-design-options"><?php echo esc_html_x('Reset design options','Admin Panel','businesslounge') ?></a></div>
			<?php endif;?>
