...
class Widget_RT_Blog extends Widget_Base {
	...
	public function get_title() {
		return "[RT] ".esc_html_x( 'Blog List', 'Adnin Panel', 'businesslounge' );
	}
	...
	protected function _register_controls() {
		...
		// Content Controls
  		$this->start_controls_section(
  			...
  			[
  				'label' => esc_html_x( 'Blog List','Admin Panel','businesslounge' )
  			]
  		); 
		...
		$this->add_control(
			'use_excerpts',
			[
				'label' => esc_html_x("Excerpts", 'Admin Panel','businesslounge'),
 		...
 		$this->add_control(
				...
				[
					...
					"description" => esc_html_x("Customize the excerpt length. Leave blank for the default value.",'Admin Panel','businesslounge'),
					'type'    => Controls_Manager::NUMBER,
					'default' =>  "100",
					'condition' => [
										'use_excerpts' => [ "true" ],
