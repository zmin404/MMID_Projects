...
if( ! function_exists("rtframework_settings") ){
	...
	function rtframework_settings(){
		...
		$rtframework_settings["content_sidebar_width"] = apply_filters("rtframework_content_sidebar_width", 910);	
...
if( ! function_exists("rtframework_get_image_data") ){
	...
	function rtframework_get_image_data($args){
		...
		if( $image ){
				...
				//attachment data
				$attachment             = get_post( $image_id, "attachment" ) ;	
	...
	function rtframework_content_container($atts) {
		...
		if( $atts["action"] == "start" ){		
			...
			if( isset( $atts["sidebar"] ) && $atts["sidebar"] != "fullwidth" ){		
				...
				$output .= '<div class="col col-md-12 col-xs-12 content'.$col_class.'">'."\n";
				$output .= $atts["echo"] && isset($atts["sidebar"]) ? apply_filters( "rt_before_main_content", "" ) : "" ;
			}		
		}
...
add_action( "rtframework_get_post_navigation", "rtframework_get_post_navigation", 10 );
...
if( ! function_exists("rtframework_search_button") ){
	...
	function rtframework_search_button(  $number ){
		...
		$button_output = '<li class="search-button tools-icon"><a href="#" class="businesslounge-search-button" title="'.esc_html__("Search","businesslounge").'"><span class="ui-icon-top-search"></span></a></li>'."\n";
		echo $button_output;
...
if( ! function_exists("rtframework_side_panel_button") ){
	...
	function rtframework_side_panel_button(  $number ){
		...
		$button_output = '<li class="businesslounge-sidepanel-button-holder"><a href="#" class="businesslounge-menu-button businesslounge-sidepanel-button"><span></span><span></span><span></span></a></li>'."\n";
		echo $button_output;
...
if( ! function_exists("businesslounge_version_1_4_fixes") ){
	...
	function businesslounge_version_1_4_fixes($old_version,$new_version){
		...
		if( version_compare($old_version,"1.4","<") && version_compare($new_version,"1.4",">=") ){
			...
			$footer_list_layout = esc_attr(get_theme_mod('businesslounge_footer_widget_layout'));						
