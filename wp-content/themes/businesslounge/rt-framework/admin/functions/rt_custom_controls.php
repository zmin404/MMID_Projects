		...
		class RT_Customize_Media_Control extends WP_Customize_Control {
			...
			public function render_content() {
				...
				<label>
					...
					echo '<span class="rt-panel-icon-cancel delete_single" title="'.esc_html_x("remove image",'Admin Panel','businesslounge').'" data-inputid="'.$id.'"></span>';
					echo '</div>';
					?>
				...
				<label>
					...
					<div class="customize-control-content">
						<div class="wp-picker-container">
							<a class="rt-color-control-result wp-color-result" tabindex="0" style="background-color: <?php echo $this->value(); ?>" title="<?php echo esc_html_x("Select Color",'Admin Panel','businesslounge'); ?>" data-current="<?php echo esc_html_x("Current Color",'Admin Panel','businesslounge'); ?>"></a>
							
							<span class="wp-picker-input-wrap">
								<input type="text" value="<?php echo $this->value(); ?>" <?php $this->link(); ?> class="wp-color-picker" data-default-color="<?php echo $this->default; ?>" style="display:none;"  <?php $this->input_attrs(); ?>>
		...
		class RT_SubSection_Heading extends WP_Customize_Control {
			...
			public function render_content() {  
				?>
					<label  <?php $this->input_attrs(); ?>>
						<?php if ( ! empty( $this->label ) ) : ?> 
							<h3 class="rt-customizer-subsection-title"><span class="dashicons-arrow-down-alt2"></span><?php echo $this->label; ?></h3>
						<?php endif;
						if ( ! empty( $this->description ) ) : ?>
							<span class="description customize-control-description"><?php echo $this->description; ?></span>
						<?php endif; ?>
